 ...
 * @ingroup tms570
 *
 * @brief API of the Watchdog driver for the tms570 bsp in RTEMS.
 */
...
#ifndef LIBBSP_ARM_TMS570_WATCHDOG_H
#define LIBBSP_ARM_TMS570_WATCHDOG_H
 ...
 *         FALSE otherwise.
 */
bool tms570_been_reset_by_watchdog( void );

/**
 * @brief Resets the watchdog timer.
 */
void tms570_watchdog_reset( void );
 ...
 */
rtems_status_code tms570_watchdog_config( tms570_microseconds tcount );
...
rtems_status_code tms570_watchdog_config_with_interrupt(
  tms570_wd_isr_funct interrupt,
  tms570_microseconds tcount
);
...
#endif  /* LIBBSP_ARM_TMS570_WATCHDOG_H */
