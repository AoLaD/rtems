...
#ifndef LIBBSP_ARM_TMS570_IO_H
#define LIBBSP_ARM_TMS570_IO_H
 ...
 */
void tms570_pin_select(
  uint32_t             pin,
  tms570_pin_function function
);
 ...
 */
rtems_status_code tms570_module_enable(
  tms570_module       module,
 ...
 */
rtems_status_code tms570_module_disable( tms570_module module );
 ...
 *         FALSE otherwise.
 */
bool tms570_module_is_enabled( tms570_module module );

#ifdef __cplusplus
}
#endif /* __cplusplus */

#endif /* LIBBSP_ARM_TMS570_IO_H */
