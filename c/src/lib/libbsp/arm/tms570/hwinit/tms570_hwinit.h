...
#define TMS570_TCRAM_START_PTR       ( (volatile uint32_t *) ( 0x08000000U ) )
#define TMS570_TCRAM_WINDOW_END_PTR  ( (volatile uint32_t *) ( 0x08080000U ) )

#define TMS570_SDRAM_START_PTR      ( (volatile uint32_t *) ( 0x80000000U ) )
#define TMS570_SDRAM_WINDOW_END_PTR ( (volatile uint32_t *) ( 0xA0000000U ) )
